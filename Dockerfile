...
RUN apt-get update && apt-get install -y nginx libpng12-dev libjpeg-dev libpq-dev php5-mcrypt libmcrypt-dev php5-gd libgd2-xpm-dev* libfreetype6-dev libjpeg62-turbo-dev cron vim net-tools
